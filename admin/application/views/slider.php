...
<head>
	...
	<title>New Slide | Garlic Admin</title>
...
<body>
	...
	<div id="navbar" >
		<ul class="nav nav-pills nav-stacked">
			...
			<li role="presentation"><a href="#new_slide">New Slide</a></li>
	...
	<section class="new_slide">
		<div class="container">
			<h2>New Slide</h2>
			<hr>
			<br>
			<form class="form-horizontal" method="POST" action="<?php echo base_url() ?>slider/do_upload"  enctype="multipart/form-data" >
				<!-- Photo upload -->
				<strong>Add Slide:</strong><input type="file" name="userfile" size="20" required/>
				<small>File size should be less than 200 KB</small>
				<small></small>
